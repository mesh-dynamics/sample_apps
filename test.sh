...
record() {
  RECORDING_ID=$(curl -X POST $CUBE_ENDPOINT/api/cs/start/CubeCorp/Jersy2xApp/prod/default \
...
generate_traffic() {
  for ((i=1;i<=$1;i++)); do
    ...
    curl -f -X GET "http://jersy2x.dev.cubecorp.io:8080/minfo/listmovies?filmName=ACADEMY%20DINOSAUR"
